...
elseif (isset($_REQUEST['install1']) || isset($_REQUEST['back1']))
{
	...
	<td><form name='langform' action='" . htmlspecialchars($_SERVER['PHP_SELF'], ENT_QUOTES) . "' method=\"post\">".selection($langLanguages, 'lang', $lang, 'onChange="document.langform.submit();"')."</form></td>
	</tr>
	<tr>
