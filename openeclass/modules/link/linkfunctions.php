...
function showcategoryadmintools($categoryid)
{
	...
	$tool_content .=  "
      <td width='45' align='right'><a href=\"" . htmlspecialchars($_SERVER['PHP_SELF']) . "?action=editcategory&amp;id=$categoryid&amp;urlview=$urlview\"><img src=\"../../template/classic/img/edit.gif\" title=\""
