...
$tool_content .= "<form method='post' name='createform' action='" . htmlspecialchars($_SERVER['PHP_SELF'], ENT_QUOTES) . "' onsubmit=\"return checkrequired(this, 'intitule', 'titulaires');\">";
